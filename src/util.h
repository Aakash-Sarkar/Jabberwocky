...
//		it herself. But it also adds the extra overhead of zeroing out the
//		bytes each time the memory is allocated.
//
//
/////////////////////////////////////////////////////////////////////////////////
...
//
//
//		There are situations in which avoiding the cost of zeroing out
//		memory is more desirable. For e.g. if the allocated memory is
//		too large or if the user is anyway going to set it to some
//		other value. Color buffers are an appropriate example of this.
//		The buffers tend to be large and are always cleared out to
//		some initial color before the next draw call.
//
//
/////////////////////////////////////////////////////////////////////////////////

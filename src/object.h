...
//
//
//		The concept of objects is so fundamental in Software Design that even
//		C programmers have found a way to emulate it in their programs. But
//		why is it needed? And can I get away with writing my program without
//		having to know or rely upon object oriented programming principles?
//		The question is a little complex to answer; so please follow along
//		till the end.
//
// 
//		You are free to write your program in any way you see fit. However if
//		you're writing a complex program with lots of structures and functions,
//		you'll increasingly begin to realize that using some of the features
//		of object oriented programming in your design, makes certain things a
//		lot easier for you. I'm noting down a few examples below, but you can
//		also browse through the code and find out your own.
//
//
//		First is the idea of thinking in terms of objects:
//
//		Imagine you're writing a commercial software and you start off with
//		the following approach:
//
//		1.	My program will begin at the main function and inside that it'll
//			have a for loop.
//
//		2.	At every iteration of the loop, collect the inputs from the user.
//
//		3.	Based on the inputs we call some functions with arguments based
//			on the inputs given by user.
//
//		4.	Each function will in turn make some other function calls based
//			on the arguments given and so on...
//
//
//		This is the typical procedure oriented approach. We decompose the
//		process of determining the output from the given inputs into a sequence
//		of function calls or procedures. Each function is itself composed of
//		smaller functions and so on, down to the level of a single processor
//		instruction!
//
//
//		The problem with this approach is the following:
//
//		In order to make sure that any new change that you add to your program
//		does not introduce any new bugs, you need to keep track of every
//		sequence of function calls that your program can take and check if it
//		is still correct with this change. And remember that your program can
//		take a different path at every if-else or branch statement! This can
//		be a headache with just 2 or 3 source files. But in a commercial
//		application with thousands of functions and branches, it'll become like
//		keeping track of each thread in a spider's web!
//
//
...
//			their initial states. Inside the main loop we change the
//			state of each object based on the user input.
//
//
////////////////////////////////////////////////////////////////////////////////
